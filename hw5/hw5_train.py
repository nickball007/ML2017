...
model.add(Embedding(num_words,
                    ...
                    trainable=False))
model.add(GRU(256,activation='tanh',dropout=0.2))
...
adam = Adam(lr=0.002,decay=1e-6,clipvalue=0.6)
...
checkpoint = ModelCheckpoint(filepath='finalbest.hdf5',
                                verbose=1,
                                save_best_only=True,
